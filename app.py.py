 ...
 "cells": [
  {
   ...
   "source": [
    ...
    "    \n",
    "    if pdf_files:\n",
    "        st.info(f\"📚 {len(pdf_files)} PDF(s) available\")\n",
    "        \n",
    "        # Select PDF\n",
    ...
    "                <b>📄 File:</b> {selected_file}<br>\n",
    "                <b>📑 Pages:</b> {doc.page_count}<br>\n",
    "                <b>💾 Size:</b> {pdf_path.stat().st_size / 1024:.1f} KB\n",
    "            </div>\n",
    "            \"\"\", unsafe_allow_html=True)\n",
    "            doc.close()\n",
    "    else:\n",
    "        st.warning(f\"No PDFs found in: {PATENTS_FOLDER}\")\n",
    "        st.info(\"💡 Add PDF files to the Patents folder\")\n",
    "    \n",
    "    # Upload new PDF\n",
    "    st.markdown(\"---\")\n",
    ...
    "        \n",
    "        # Keywords input\n",
    "        st.subheader(\"🔑 Enter Keywords/Phrases\")\n",
    "        \n",
    ...
    "            \n",
    "            # Highlight info\n",
    "            st.info(f\"🎨 {st.session_state.total_highlights} areas highlighted in PDF\")\n",
    "    else:\n",
    "        st.info(\"👈 Select a PDF from the Source panel to begin\")\n",
    "\n",
    "# ============================================================================\n",
    ...
    "\n",
    "with col3:\n",
    "    st.markdown('<div class=\"column-header\">📄 PDF VIEWER</div>', unsafe_allow_html=True)\n",
    "    \n",
    ...
    "        pdf_path = PATENTS_FOLDER / f\"{selected_file}.pdf\"\n",
    "        \n",
    "        st.info(\"👈 Click ANALYZE to see highlighted version\")\n",
    "        \n",
    "        # Show original PDF\n",
    "        with open(pdf_path, \"rb\") as f:\n",
    "            base64_pdf = base64.b64encode(f.read()).decode('utf-8')\n",
    ...
    "    \n",
    "    else:\n",
    "        st.info(\"📄 PDF will appear here after analysis\")\n",
    "\n",
    "# Footer\n",
    "st.markdown(\"---\")\n",
    "st.markdown(\"\"\"\n",
    "<div style=\"text-align: center; color: #666; padding: 20px;\">\n",
    "    🔍 AI Patent Analyzer | Built with Streamlit | \n",
